    ...
    switch (statement.kind) {
      ...
      case Node.Var:
        ...
        if (t !== i && t !== errorType)
          error(
            statement.init.pos,
            `Cannot assign initialiser of type '${typeToString(i)}' to variable with declared type '${typeToString(
              t,
            )}'.`,
          )
        return t
      ...
      case Node.Assignment:
        ...
        if (t !== v)
          error(
            ...
            `Cannot assign value of type '${typeToString(v)}' to variable of type '${typeToString(t)}'.`,
          )
        return t
    }
  }
